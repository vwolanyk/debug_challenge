...
ActiveRecord::Schema.define(version: 20170811182747) do
  ...
  create_table "company_invoices", force: :cascade do |t|
    t.integer "company_id"
    t.integer "invoice_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["company_id"], name: "index_company_invoices_on_company_id"
    t.index ["invoice_id"], name: "index_company_invoices_on_invoice_id"
  end
